...
import { connect, disconnect, subscribeToNewDevs, oneDevHasBeenDeleted } from '../services/socket'
...
function Main({ navigation }) {
  ...
  return (
    <>
      ...
      >
        {devs.map(dev => {
          const { _id, avatar_url, github_username, name, bio, techs } = dev
          const [longitude, latitude] = dev.location.coordinates

          return (
            <Marker key={_id} coordinate={{ longitude, latitude, }} >
